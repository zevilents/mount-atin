...
-- Tombol Rejoin
createButton("🔁 Rejoin Server", y, function()
...
welcomeTitle.Text = "⛰️SCRIPT MOUNT ATIN⛰️"
...
subtitle.Text = "BANTU PLAYER LAIN!!!"
